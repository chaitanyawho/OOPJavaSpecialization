...
public abstract class Graph {
	...
	public List<Integer> degreeSequence() {
		...
		for(int i = 0;i<numVertices;i++) {
			t = getNeighbors(i).size();
			t+= getInNeighbors(i).size();
			dSeq.add(i, t);
		}
	...
	public static void main (String[] args) {
		...
		//GraphLoader.createIntersectionsFile("data/maps/manipal.map", "data/intersections/manipal.intersections");
		...
		System.out.println("\n****");
		GraphLoader.loadRoadMap("data/maps/manipal.map", graphFromFile);
		System.out.println(graphFromFile);
