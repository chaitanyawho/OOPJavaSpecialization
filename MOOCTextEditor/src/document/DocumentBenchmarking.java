	...
	public static void main(String [] args) {
				...
				numToCheck += increment)
		{
			...
			for(int i = 0;i<trials;i++) {
				d = new BasicDocument(text);
				d.getFleschScore();
			}
			bend = System.nanoTime();
			bdif = (bend-bstart)/1000000000.0;
			
			estart = System.nanoTime();
			for(int i = 0;i<trials;i++) {
				d = new EfficientDocument(text);
				d.getFleschScore();
			}
			eend = System.nanoTime();
			edif = (eend-estart)/1000000000.0;
			System.out.println(numToCheck/1000+"\t"+bdif+"\t"+edif);
